...
When citing a reference (with \cmd{cite}, \cmd{footcite} or other citation command), you can add the division of source in parenthesis in the \opt{prenote} arg. The syntax of rest of the \opt{prenote} arg is the normal syntax of \biblatex.

For example, our \file{.bib} for us texts in this documentation introduction is:

\inputminted{biblatex-source-division.bib}
